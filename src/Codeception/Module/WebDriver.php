    ...
    ConflictsWithModule
{
    ...
    public function _failed(TestInterface $test, $fail)
    {
        ...
        $filename = preg_replace('~\W~u', '.', Descriptor::getTestSignature($test));
        $outputDir = codecept_output_dir();
        $this->_saveScreenshot($outputDir . mb_strcut($filename, 0, 200, 'utf-8') . '.fail.png');
        $this->_savePageSource($outputDir . mb_strcut($filename, 0, 200, 'utf-8') . '.fail.html');
